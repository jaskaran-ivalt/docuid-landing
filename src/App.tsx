  ...
  return (
    <div className="min-h-screen bg-brand-50 text-brand-900 font-sans selection:bg-accent-500 selection:text-white">
        ...
        <div className="max-w-5xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <a
              ...
              className="text-xs font-mono font-bold text-brand-500 hover:text-accent-500 transition-colors uppercase tracking-widest flex items-center gap-1.5"
            >
      ...
      <main className="pt-16">
          ...
          <div className="max-w-5xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-base text-brand-600 mb-8 leading-relaxed max-w-md">
                Securely access and manage your docuid.net library directly
                within Microsoft Word. Authenticate instantly using iVALT
                biometrics.
              </p>
              ...
              >
                ...
                <div>
                  <p className="text-[10px] font-bold text-brand-400 uppercase tracking-widest leading-none mb-1">
                    Microsoft Word Store
                  </p>
                  <p className="text-xs font-bold text-brand-900">
                    Official Add-on Coming Soon
                  </p>
                </div>
              </motion.div>
            </motion.div>
            ...
            >
              ...
              >
                <div className="flex items-center gap-2 mb-6 pb-4 border-b border-brand-100">
                  ...
                  <div className="w-2 h-2 rounded-full bg-brand-200"></div>
                  <div className="w-2 h-2 rounded-full bg-brand-200"></div>
                  <span className="ml-2 text-[10px] font-mono text-brand-400">
                    DocuId Add-on
                  </span>
                </div>
                ...
                <div className="bg-brand-900 rounded-xl p-6 text-center text-white relative overflow-hidden">
                  ...
                  <p className="text-xs font-mono uppercase tracking-widest mb-2 relative z-10">
                    Awaiting iVALT Auth
                  </p>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div className="space-y-6">
                {[
                  {
                    step: "1",
                    text: "Download and install the Windows 11 Add-on.",
                  },
                  {
                    step: "2",
                    text: "Login with your docuid.net credentials.",
                  },
                  {
                    step: "3",
                    text: "Open MS Word and locate the DocuId sidebar.",
                  },
                  {
                    step: "4",
                    text: "Authenticate via iVALT to access your library.",
                  },
                ].map((s, i) => (
              ...
              <div className="bg-brand-900 rounded-2xl p-8 text-white flex flex-col justify-center relative overflow-hidden">
                <div className="relative z-10">
                  ...
                  <p className="text-sm text-brand-300 font-light mb-6 leading-relaxed">
                    Our first release focuses on core security. Access your
                    uploaded documents on www.docuid.net securely using this
                    add-on.
                  </p>
        ...
        <section
          id="download"
          className="py-16 bg-white border-t border-brand-200"
        >
          <div className="max-w-5xl mx-auto px-6 text-center">
            ...
            <p className="text-sm text-brand-500 mb-10 max-w-md mx-auto">
              Download the standalone installer for Windows 11. Official
              Microsoft Word Store version coming soon.
            </p>
